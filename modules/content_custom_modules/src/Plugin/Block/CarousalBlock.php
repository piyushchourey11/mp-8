...
class CarousalBlock extends BlockBase {
  ...
  if($frontPage) {
          ...
          if($nodesCarouselData->hasField('field_add_carousels') && !$nodesCarouselData->get('field_add_carousels')->isEmpty()){
                $counter = 0;
                while ($counter < count($nodesCarouselData->field_add_carousels)) {
                    $carousels[$counter] = $nodesCarouselData->field_add_carousels[$counter]->target_id;
                    $counter++;
                }
            }
